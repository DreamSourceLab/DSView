...
/* Name of package */
#define PACKAGE "libsigrok4DSLogic"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "support@dreamsourcelab.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "libsigrok4DSLogic"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "libsigrok4DSLogic 0.2.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "libsigrok4DSLogic"
